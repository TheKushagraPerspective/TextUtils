    ...
    return (
        <>
            ...
            <div>
                ...
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnLowerCase}>Change to LowerCase</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnClearText}>Clear Text</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnSpeak}>Speak</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnSpeakPause}>Speak Pause</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnSpeakResume}>Speak Resume</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnStopSpeak}>Stop Speak</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleOnReverseTheText}>Reverse the Text</button>
